...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    _______, _______, _______, _______, RGB_VAI, _______, 		   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
             _______, _______, _______, RGB_VAD, _______, _______, _______, _______,          _______,          _______,          _______, _______, _______, _______, _______, _______
  )
};

//----------------------------------------------------------
// Encoder map
#define BASE_ENCODERS { ENCODER_CCW_CW(KC_VOLD, KC_VOLU), ENCODER_CCW_CW(RGB_VAD, RGB_VAI)}

const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    [_QWERTY]   = BASE_ENCODERS,
    [_FUNC]     = { ENCODER_CCW_CW(RGB_MOD, RGB_RMOD), ENCODER_CCW_CW(RGB_VAD, RGB_VAI) }
};
// clang-format on